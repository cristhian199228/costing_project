            ...
            fn: function() {
              return [
                _c(
                  ...
                  { attrs: { flat: "" } },
                  [
                    _c("v-toolbar-title", [_vm._v("Presupuesto de Prueba")]),
                    _vm._v(" "),
                    _c("v-divider", {
                      staticClass: "mx-4",
              ...
              return [
                _c("v-text-field", {
                  ...
                  model: {
                    value: item.calories,
                    callback: function($$v) {
                      _vm.$set(item, "calories", _vm._n($$v))
                    },
                    expression: "item.calories"
                  }
                })
              ]
            }
